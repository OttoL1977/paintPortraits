...
var modals = function modals(state) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var tabs = document.querySelectorAll('.balcon_icons_img');
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        if (state.form && state.height && state.width && triggerSelector == '.popup_calc_button' || triggerSelector == '.popup_calc_btn' || triggerSelector == '.popup_engineer_btn' || triggerSelector == '.phone_link' || state.type && state.profile) {
          if (e.target) {
            e.preventDefault();
          }
    ...
    close.addEventListener('click', function () {
      ...
      bigImage.forEach(function (item) {
        item.style.display = 'none';
      });
